...
exports.Renardoo = void 0;
const child_process_1 = require("child_process");
const events_1 = require("events");
class Renardoo extends events_1.EventEmitter {
    constructor(logger) {
        super();
        this.logger = logger;
        const pythonPath = atom.config.get('renardoo.pythonPath') || 'python';
        const samplesDirectory = atom.config.get('renardoo.samplesDirectory');
        ...
        try {
            this.childProcess = (0, child_process_1.spawn)(pythonPath, command, {
                env: Object.assign(Object.assign({}, process.env), { SC3_PLUGINS: atom.config.get('renardoo.useSC3Plugins')
                        ? '1'
                        : undefined }),
            });
            ...
            this.childProcess.on('error', (err) => {
                if (err.code === 'ENOENT') {
                    logger === null || logger === void 0 ? void 0 : logger.service(`Python was not found. Check that you have Python installed. You may need to give the full path to the Python executable in the Renardoo package's settings.`, true);
                }
                logger === null || logger === void 0 ? void 0 : logger.service(err.toString(), true);
            });
            this.childProcess.on('close', (code) => {
                if (code) {
                    logger === null || logger === void 0 ? void 0 : logger.service(`Renardoo has exited with code ${code}.`, true);
                }
                else {
                    logger === null || logger === void 0 ? void 0 : logger.service('Renardoo has stopped.', false);
                }
                this.childProcess = undefined;
                this.emit('stop');
            });
            logger === null || logger === void 0 ? void 0 : logger.service('Renardoo has started.', false);
        }
        catch (err) {
